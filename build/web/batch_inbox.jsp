...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <title>Total Card | Batch InBox </title>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <!-- /BREADCRUMBS -->
                                        <div class="clearfix">
                                            <h3 class="content-title pull-left">Batch Inbox Report</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="box border blue">
                                        <div class="box-title">
                                            <h4><i class="fa fa-table"></i>Batch Inbox List</h4>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function () {
                ...
                var table = $('#cust_datatable').DataTable({
                    ...
                    "serverSide": true,
//                    "searching": false,
                    "ajax": "Controller?Type=38&Mode=1",
                     "columns": [
                                    {"data": 1},
                                    {"data": 2},
                                    {"data": 4},
                    ...
                    "createdRow": function (row, data, index) {                                  
                        $('td', row).eq(4).html('<a href="#handler?Type=36&id=' + data[0] + '">' +
          ...
          //    alert(JSON.stringify(table));
                $("#download").click(function () {
                    ...
                    window.location= "handler?Type=36&columns[2][search][value]=&download=1&"+$.param(data);
                });

                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <!-- /BREADCRUMBS -->
                                        <div class="clearfix">
                                            <h3 class="content-title pull-left">Card Blacklist</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box border blue">
                                        <div class="box-title">
                                            <h4><i class="fa fa-book"></i>Card Blacklist</h4>
                                            <div class="tools">
                                        ...
                                        <div class="box-body">
                                            <div class="tabbable">
                                                        <div class="row">
                                                                    ...
                                                                    <input  type="hidden" name="id" value="${request.getAttribute('cardnumber')}"/>

    ...
    <!-- /TEAM STATUS -->
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="box-body big">
                                                                <form class="form-horizontal acc-ops" action="createuser"> 
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <select id="usergroup" name ="usergroup"  class="form-control input-sm"><option value="">Select User Group</option></select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
        ...
        <script type="text/javascript">
            jQuery(document).ready(function () {
                ...
                $.getJSON("handler?Type=34", function (json) {
                    $.each(json.data, function () {
                        $('#usergroup').append($("<option></option>").text(this[1]).val(this[0]));
                    });
                });

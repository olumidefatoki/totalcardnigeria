...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <title>Total Card | Batch Entries</title>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-header">
                                        ...
                                        <!-- /BREADCRUMBS -->
                                        <div class="clearfix">
                                            <h3 class="content-title pull-left">Batch Entries Report</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="box border blue">
                                        <div class="box-title">
                                            <h4><i class="fa fa-table"></i>Uploaded Data</h4>
                                        ...
                                        <div class="box-body">
                                            <div class="row">
                                                ...
                                                <input  type="hidden" id="batch_entry_id" value="${requestScope.BatchEntryID}"/>
...
//                    "searching": false,
          ...
          //    alert(JSON.stringify(table));
                $("#download").click(function () {
                    ...
                    window.location= "Controller?Type=36&columns[2][search][value]=&download=1&"+$.param(data);
                });
